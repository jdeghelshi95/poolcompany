        ...
        <div className="bg-gray-50 py-16 px-4 sm:px-6 lg:col-span-2 lg:px-8 lg:py-24 xl:pr-12">
          <div className="mx-auto max-w-lg">
            ...
            <p className="mt-3 text-lg leading-6 text-gray-500">
              Please contact us via or email or phone to get a free on site estimate. We look forward speaking to you soon. 
            </p>
            <dl className="mt-8 text-base text-gray-500">
              ...
              <div className="mt-6">
                ...
                <dd className="flex">
                  ...
                  <span className="ml-3">+1 (908)-222-2803 </span>
                </dd>
              </div>
              <div className="mt-3">
                ...
                <dd className="flex">
                  ...
                  <span className="ml-3">info@bairespool.com</span>
                </dd>
              </div>
            </dl>
